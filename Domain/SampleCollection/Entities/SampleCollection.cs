...
namespace eMedLis.Domain.SampleCollection.Entities
{
    ...
    {
        public PatientBilling.Entities.PatientInfo PatientInfo { get; set; }
        public PatientBilling.Entities.BillSummary BillSummary { get; set; }
        public List<PatientBilling.Entities.BillDetail> BillDetails { get; set; }
