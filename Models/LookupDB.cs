...
namespace eMedLis.Models
{
    public class LookupDB
    {
        ...
        int StatusCode;
        string StatusMsg = "";
        public Tuple<int, string> Add_Record(Lookup dp)
        {
            int i;
        ...
        public List<Lookup> Get_Record(string ItemType)
        {
            List<Lookup> rec = new List<Lookup>();
            SqlCommand com = new SqlCommand("Usp_Lookup", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        //Update Lookup
        public Tuple<int, string> Update_Record(Lookup dp)
        {
            int i;
            SqlCommand com = new SqlCommand("Usp_Lookup", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        //Get Record By Id
        public List<Lookup> Get_RecordsById(int Id)
        {
            List<Lookup> rec = new List<Lookup>();
            SqlCommand com = new SqlCommand("Usp_Lookup", con);
            com.CommandType = CommandType.StoredProcedure;
