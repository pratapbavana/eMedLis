...
namespace eMedLis.Models
{
    public class InvMasterDB
    {
        ...
        int StatusCode;
        string StatusMsg = "";
        public Tuple<int, string> Add_Investigation(InvMaster dp)
        {
            int i;
        ...
        public List<InvMaster> Get_Investigation()
        {
            List<InvMaster> inv = new List<InvMaster>();
            SqlCommand com = new SqlCommand("Usp_InvMaster", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        //Update Inv
        public Tuple<int, string> Update_Investigation(InvMaster dp)
        {
            int i;
            SqlCommand com = new SqlCommand("Usp_InvMaster", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        //Get Record By Id
        public List<InvMaster> Get_InvestigationById(int Id)
        {
            List<InvMaster> inv = new List<InvMaster>();
            SqlCommand com = new SqlCommand("Usp_InvMaster", con);
            com.CommandType = CommandType.StoredProcedure;
