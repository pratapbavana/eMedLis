...
namespace eMedLis.Models
{
    public class DepartmentDB
    {
        ...
        int StatusCode;
        string StatusMsg = "";
        public Tuple<int, string> Add_Department(Department dp)
        {
            int i;
        ...
        //Update Department
        public Tuple<int, string> Update_Department(Department dp)
        {
            int i;
            SqlCommand com = new SqlCommand("Usp_Department", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        //Get Record By Id
        public List<Department> Get_DepartmentById(int Id)
        {
            List<Department> dept = new List<Department>();
            SqlCommand com = new SqlCommand("Usp_Department", con);
            com.CommandType = CommandType.StoredProcedure;
