...
namespace eMedLis.Infrastructure.Data.SubDepartment
{
    public class SubDepartmentDB
    {
        ...
        int StatusCode;
        string StatusMsg = "";
        public Tuple<int , string> Add_SubDepartment(SubDepartments dp)
        {
            int i;
        ...
        public List<SubDepartments> Get_SubDepartment()
        {
            List<SubDepartments> dept = new List<SubDepartments>();
            SqlCommand com = new SqlCommand("Usp_SubDepartment", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        public Tuple<int, string> Update_SubDepartment(SubDepartments dp)
        {
            int i;
        ...
        //Get Record By Id
        public List<SubDepartments> Get_SubDepartmentById(int Id)
        {
            List<SubDepartments> subdept = new List<SubDepartments>();
            SqlCommand com = new SqlCommand("Usp_SubDepartment", con);
            com.CommandType = CommandType.StoredProcedure;
            ...
            while (rdr.Read())
            {
                subdept.Add(new SubDepartments
                {
                    Id = Convert.ToInt32(rdr["Id"]),
                    SubDeptName = rdr["SubDeptName"].ToString(),
        ...
        public List<SubDepartments> Get_SubDepartmentByDeptId(int DeptId)
        {
            List<SubDepartments> dept = new List<SubDepartments>();
            SqlCommand com = new SqlCommand("Usp_SubDepartment", con);
            com.CommandType = CommandType.StoredProcedure;
